...
import com.hq.hlibrary.net.okhttp.TrustManager;
import com.hq.hlibrary.net.okhttp.cache.CacheInterceptor;
...
//            .addInterceptor(cacheInterceptor)
            ...
            // 设置 Cookie
            .cookieJar(new CookieManger(AppInfoUtils.INSTANCE.getContext()))
            //time out

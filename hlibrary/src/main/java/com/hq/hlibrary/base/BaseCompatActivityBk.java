 ...
 * @author Alex
 */
public abstract class BaseCompatActivityBk extends AppCompatActivity {
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    protected void initData() {
        mContext = AppInfoUtils.INSTANCE.getContext();
    ...
    public static class NetWorkBroadcastReceiver extends BroadcastReceiver {
        ...
        private WeakReference<BaseCompatActivityBk> weakReference;

        public NetWorkBroadcastReceiver(BaseCompatActivityBk baseCompatActivity) {
            weakReference = new WeakReference<>(baseCompatActivity);
        }

        @Override
        public void onReceive(Context context, Intent intent) {
            BaseCompatActivityBk baseCompatActivity = weakReference.get();

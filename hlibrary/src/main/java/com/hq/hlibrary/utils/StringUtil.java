...
public class StringUtil {
     ...
     * @return
     */
    public static boolean isServiceRunning(Context mContext, String service_cls) {
        ActivityManager am = (ActivityManager) mContext
                .getSystemService(Context.ACTIVITY_SERVICE);
        for (ActivityManager.RunningServiceInfo service : am
                .getRunningServices(Integer.MAX_VALUE)) {
            if (service_cls.equals(service.service.getClassName())) {
                return true;
            }
        }
